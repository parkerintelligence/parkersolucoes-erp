      ...
      <ScrollArea className="flex-1">
        <CardContent className="space-y-4 text-foreground">
          <div className="space-y-3">
            ...
            {contact?.email && (
              <div>
                <p className="text-xs font-medium text-muted-foreground mb-1 flex items-center gap-1"><Mail className="h-3 w-3" />Email</p>
          ...
          <div className="space-y-3">
            <div>
              <p className="text-xs font-medium text-muted-foreground mb-1 flex items-center gap-1"><MessageCircle className="h-3 w-3" />Canal</p>
              <p className="text-sm capitalize">{conversation.channel || 'WhatsApp'}</p>
            </div>
            <div>
              <p className="text-xs font-medium text-muted-foreground mb-1 flex items-center gap-1"><Calendar className="h-3 w-3" />Criado em</p>
              <p className="text-sm">{format(new Date(conversation.created_at), "dd 'de' MMMM 'de' yyyy 'às' HH:mm", { locale: ptBR })}</p>
            </div>
            <div>
              <p className="text-xs font-medium text-muted-foreground mb-1">Última atividade</p>
              <p className="text-sm">{format(new Date(conversation.last_activity_at), "dd 'de' MMMM 'às' HH:mm", { locale: ptBR })}</p>
            </div>
            <div>
