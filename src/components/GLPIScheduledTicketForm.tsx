      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card className="bg-secondary border-border">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="name" className="text-foreground">Nome do Agendamento *</Label>
              <Input
                id="name"
                value={formData.name}
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="is_active" className="text-foreground">Agendamento ativo</Label>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-secondary border-border">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="content" className="text-foreground">Descrição do Chamado *</Label>
              <Textarea
                id="content"
        ...
        <Card className="bg-secondary border-border">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Select value={formData.priority.toString()} onValueChange={(value) => setFormData({ ...formData, priority: parseInt(value) })}>
                  ...
                  <SelectContent className="bg-muted border-border">
                    {PRIORITY_OPTIONS.map((option) => (
                      <SelectItem key={option.value} value={option.value.toString()} className="text-foreground hover:bg-gray-500">
                        {option.label}
                      </SelectItem>
                    ))}
                  </SelectContent>
              ...
              <div className="space-y-2">
                <Label htmlFor="urgency" className="text-foreground">Urgência</Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="impact" className="text-foreground">Impacto</Label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="type" className="text-foreground">Tipo do Chamado</Label>
                <Input
                  id="type"
                  type="number"
                  value={formData.type}
              ...
              <div className="space-y-2">
                <Label htmlFor="entity_id" className="text-foreground">ID da Entidade</Label>
                <Input
                  id="entity_id"
                  type="number"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                <Label htmlFor="category_id" className="text-foreground">ID da Categoria (opcional)</Label>
                <Input
                  id="category_id"
                  type="number"
              ...
              <div className="space-y-2">
                <Label htmlFor="assign_user_id" className="text-foreground">ID Usuário Responsável (opcional)</Label>
                <Input
                  id="assign_user_id"
                  type="number"
              ...
              <div className="space-y-2">
                <Label htmlFor="assign_group_id" className="text-foreground">ID Grupo Responsável (opcional)</Label>
                <Input
                  id="assign_group_id"
                  type="number"
        ...
        <div className="flex gap-3">
          <Button 
            ...
            className="flex items-center gap-2 bg-orange-600 hover:bg-orange-700 text-foreground"
          >
