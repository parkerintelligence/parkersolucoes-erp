...
export const TopHeader = () => {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-slate-900 text-primary-foreground shadow-lg safe-area-top">
      <div className="flex items-center justify-between w-full px-2 sm:px-3 md:px-6 py-2 sm:py-3 md:py-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
          ...
          {logoUrl ? (
            <img src={logoUrl} alt="Logo da empresa" className="h-8 sm:h-10 w-auto object-contain flex-shrink-0" />
          ) : (
            <div className="bg-secondary p-1.5 sm:p-2 rounded-xl flex-shrink-0 shadow-sm">
