import React, { createContext, useContext, forwardRef, useState, useCallback, useEffect, useMemo, type ComponentProps, type HTMLAttributes, type ComponentPropsWithoutRef, type ElementRef, type CSSProperties } from "react";
...
const SidebarTrigger = forwardRef<ElementRef<typeof Button>, ComponentPropsWithoutRef<typeof Button>>(({
  className,
  onClick,
  ...props
}, ref) => {
...
const SidebarInset = forwardRef<HTMLDivElement, ComponentProps<"main">>(({
  ...
  return <main ref={ref} className={cn(
    "relative flex min-h-svh flex-1 flex-col bg-background",
    "peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow",
    // Adiciona margem automática baseada no estado do sidebar
...
const SidebarInput = forwardRef<ElementRef<typeof Input>, ComponentPropsWithoutRef<typeof Input>>(({
  className,
  ...props
}, ref) => {
...
const SidebarSeparator = forwardRef<ElementRef<typeof Separator>, ComponentPropsWithoutRef<typeof Separator>>(({
  className,
  ...props
}, ref) => {
