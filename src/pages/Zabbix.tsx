...
const Zabbix = () => {
  ...
  const getStats = () => {
    ...
    return { onlineHosts, offlineHosts, activeProblems, highSeverityProblems, activeTriggers, totalItems };
  };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Últimos 5 problemas detectados</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Resumo do status atual</CardDescription>
                </CardHeader>
                <CardContent>
                  {hosts.slice(0, 8).map((host) => (
                    <div key={host.hostid} className="flex justify-between items-center py-2 border-b last:border-b-0">
                      <div>
              ...
              <CardContent>
                {isLoading ? (
                  ...
                  <div className="space-y-3 max-h-96 overflow-y-auto">
                    {items.map((item) => (
                      <div key={item.itemid} className="flex items-center justify-between p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 mt-1 text-xs text-gray-500">
                            ...
                            <span>Status: {item.status === '0' ? 'Ativo' : 'Inativo'}</span>
                          </div>
                        </div>
