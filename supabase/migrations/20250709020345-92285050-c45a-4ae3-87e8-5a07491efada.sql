...
-- Atualizar a função calculate_next_execution para trabalhar com timezone de Brasília
...
BEGIN
  ...
  -- Converter de volta para UTC para armazenamento consistente
  RETURN next_exec AT TIME ZONE 'America/Sao_Paulo';
END;
$function$;

-- Atualizar todas as próximas execuções existentes com o novo cálculo
