...
-- Corrigir a função calculate_next_execution para retornar corretamente o horário UTC
...
BEGIN
  ...
  -- Converter corretamente de volta para UTC para armazenamento
  RETURN timezone('UTC', next_exec);
END;
$function$;

-- Atualizar todas as próximas execuções existentes com o cálculo corrigido
